<section id="cv">
	...
	<div id="infos" class="cv_bloc">
		...
		French Driving licence - Permis B <br />
	</div>
	...
	<ul id="idioms" class="cv_bloc">
		...
		<li><span class="cv_liste">Programming : </span>JAVA, C, Pascal, HTML5, CSS3, LaTeX</li>
		<li><span class="cv_liste">Operating systems : </span>Linux (Debian) - Windows XP, 7</li>
		<li><span class="cv_liste">Softwares : </span>Eclipse, Sublime Text 2, Git, Subversion</li>
		<div class="cv_ligne"></div>
		<li><span class="cv_liste">French : </span>Native language</li>
		<li><span class="cv_liste">English : </span>Fluent</li>
		<li><span class="cv_liste">Spanish : </span>School level</li>
	</ul>
